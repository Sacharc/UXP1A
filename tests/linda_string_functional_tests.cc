...
TEST(Functional_String_Test, any_string)
{
    ...
    char value[128];
    EXPECT_TRUE(linda_read(t, "s", value));
    EXPECT_EQ(strcmp("test", value), 0);

    char value1[128];
    EXPECT_TRUE(linda_input(t, "s", value1));
    EXPECT_EQ(strcmp("test", value1), 0);
    EXPECT_FALSE(linda_read(t, "s", value));
    linda_end();
}
...
TEST(Functional_String_Test, any_string_neg)
{
    ...
    char value[128];
    EXPECT_FALSE(linda_read(t, "s", value));
    EXPECT_FALSE(linda_input(t, "s", value));
    linda_end();
}
...
TEST(Functional_String_Test, less_test)
{
    ...
    char value[128];
    EXPECT_TRUE(linda_read(t, "s<c", value));
    EXPECT_EQ(strcmp(value, "b"), 0);

    char value1[128];
    EXPECT_TRUE(linda_input(t, "s<c", value1));
...
TEST(Functional_String_Test, less_test_neg)
{
    ...
    EXPECT_TRUE(linda_output("s", "b"));
    char value[128];
    EXPECT_FALSE(linda_read(t, "s<b", value));
    EXPECT_FALSE(linda_input(t, "s<b", value));
    linda_end();
}
...
TEST(Functional_String_Test, less_eq_test2)
{
    ...
    EXPECT_TRUE(linda_output("s", "b"));
    char value[128];
    EXPECT_TRUE(linda_read(t, "s<=b", value));
    EXPECT_EQ(strcmp(value, "b"), 0);

    char value1[128];
    EXPECT_TRUE(linda_input(t, "s<=b", value1));
    EXPECT_EQ(strcmp(value1, "b"), 0);
    linda_end();
}
...
TEST(Functional_String_Test, less_eq_test_neg)
{
    ...
    EXPECT_TRUE(linda_output("s", "b"));
    char value[128];
    EXPECT_FALSE(linda_read(t, "s<=a", value));
    EXPECT_FALSE(linda_input(t, "s<=a", value));
    linda_end();
}
...
TEST(Functional_String_Test, greater_test)
{
    ...
    EXPECT_TRUE(linda_output("s", "b"));
    char value[128];
    EXPECT_TRUE(linda_read(t, "s>a", value));
    EXPECT_EQ(strcmp(value, "b"), 0);

    char value1[128];
    EXPECT_TRUE(linda_input(t, "s>a", value1));
    EXPECT_EQ(strcmp(value1, "b"), 0);
    linda_end();
}
...
TEST(Functional_String_Test, greater_test_neg)
{
    ...
    EXPECT_TRUE(linda_output("s", "b"));
    char value[128];
    EXPECT_FALSE(linda_read(t, "s>c", value));
    EXPECT_FALSE(linda_input(t, "s>c", value));
    linda_end();
}
...
TEST(Functional_String_Test, triple_output_test)
{
    ...
    {
        char value[128];
        EXPECT_TRUE(linda_input(t, "s", value));
