...
TEST(Functional_Float_Test, any_float)
{
    ...
    double value;
    EXPECT_TRUE(linda_read(t, "f", &value));
    EXPECT_EQ(0.1, value);

    double value1;
    EXPECT_TRUE(linda_input(t, "f", &value1));
    EXPECT_EQ(0.1, value1);
    EXPECT_FALSE(linda_read(t, "f", &value));
    linda_end();
}
...
TEST(Functional_Float_Test, any_float_neg)
{
    ...
    double value;
    EXPECT_FALSE(linda_read(t, "f", &value));
    EXPECT_FALSE(linda_input(t, "f", &value));
    linda_end();
}
...
TEST(Functional_Float_Test, less_test)
{
    ...
    EXPECT_TRUE(linda_output("f", 0.1));
    double value;
    EXPECT_TRUE(linda_read(t, "f<1.0", &value));
    EXPECT_EQ(0.1, value);

    double value1;
    EXPECT_TRUE(linda_input(t, "f<1.0", &value1));
    EXPECT_EQ(0.1, value1);
    linda_end();
}
...
TEST(Functional_Float_Test, less_test_neg)
{
    ...
    double value;
    EXPECT_FALSE(linda_read(t, "f<0.0", &value));
    EXPECT_FALSE(linda_input(t, "f<0.0", &value));
    linda_end();
}
...
TEST(Functional_Float_Test, less_eq_test2)
{
    ...
    EXPECT_TRUE(linda_output("f", 0.1));
    double value;
    EXPECT_TRUE(linda_read(t, "f<=0.1", &value));
    EXPECT_EQ(0.1, value);

    double value1;
    EXPECT_TRUE(linda_input(t, "f<=0.1", &value1));
    EXPECT_EQ(0.1, value1);
    linda_end();
}
...
TEST(Functional_Float_Test, greater_test_neg)
{
    ...
    EXPECT_TRUE(linda_output("f", 1.0));
    double value;
    EXPECT_FALSE(linda_read(t, "f>2.0", &value));
    EXPECT_FALSE(linda_input(t, "f>2.0", &value));
    linda_end();
}
...
TEST(Functional_Float_Test, greater_eq_test2)
{
    ...
    EXPECT_TRUE(linda_output("f", 3.0));
    double value;
    EXPECT_TRUE(linda_read(t, "f>=3.0", &value));
    EXPECT_EQ(3.0, value);

    double value1;
    EXPECT_TRUE(linda_input(t, "f>=3.0", &value1));
    EXPECT_EQ(3.0, value1);
    linda_end();
}
...
TEST(Functional_Float_Test, triple_output_test)
{
    ...
    {
        double value;
        EXPECT_TRUE(linda_input(t, "f", &value));
        EXPECT_EQ(3.0, value);
    }
